# -*- coding: utf-8 -*-
"""
Created on Wed Oct  5 21:22:02 2022
...
redhillsdb = MySQLdb.connect(host="127.0.0.1", user = "root", password = "", database="chennaiwater_db") 
# object - redhillsdb defined to created a connection with the database in the given host, user and password

with open('Monthly Lake Level Red Hills.csv') as csv_file: # to open the .csv that needs to be connected to the database
...
query = "insert into `table_redhills_monthlylakelevel`(`Year`, `January`, `February`, `March`, `April`, `May`, `June`, `July`, `August`, `September`, `October`, `November`, `December`) values(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
# to insert the given data into the designated table

dbcursor = redhillsdb.cursor()
